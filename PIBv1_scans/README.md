...
- `key_files/gencode.v38lift37.annotation.codingGENES_sorted.bed`: A BED of protein-coding genes generated by [gencodeGFFtoBED.awk](https://github.com/YourePrettyGood/HumanPopGenScripts/RefPrep/gencodeGFFtoBED.awk)
from the GFF3 format GENCODE build 38 annotation lifted to b37
...
> [!TIP]
> Stages 1 and 2 can be run simultaneously, as they are independent of each other. Stage 3 must be run after
> both Stage 1 and 2 are complete.
